...
public protocol AppStorePurchaseFlowV1 {
    typealias TransactionJWS = String
    func purchaseSubscription(with subscriptionIdentifier: String, emailAccessToken: String?) async -> Result<AppStorePurchaseFlowV1.TransactionJWS, AppStorePurchaseFlowError>
  ...
  @available(macOS 12.0, iOS 15.0, *)
  public extension AppStorePurchaseFlowV1 {
...
@available(macOS 12.0, iOS 15.0, *)
public final class DefaultAppStorePurchaseFlowV1: AppStorePurchaseFlowV1 {
    private let subscriptionEndpointService: SubscriptionEndpointServiceV1
    private let storePurchaseManager: StorePurchaseManagerV1
    private let accountManager: AccountManager
    private let appStoreRestoreFlow: AppStoreRestoreFlowV1
    private let authEndpointService: AuthEndpointService

    public init(subscriptionEndpointService: any SubscriptionEndpointServiceV1,
                storePurchaseManager: any StorePurchaseManagerV1,
                accountManager: any AccountManager,
                appStoreRestoreFlow: any AppStoreRestoreFlowV1,

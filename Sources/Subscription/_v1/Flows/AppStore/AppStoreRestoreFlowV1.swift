...
public enum AppStoreRestoreFlowErrorV1: Swift.Error, Equatable {
...
public protocol AppStoreRestoreFlowV1 {
    @discardableResult func restoreAccountFromPastPurchase() async -> Result<Void, AppStoreRestoreFlowErrorV1>
}

@available(macOS 12.0, iOS 15.0, *)
public final class DefaultAppStoreRestoreFlowV1: AppStoreRestoreFlowV1 {
    ...
    public init(accountManager: any AccountManager,
                ...
                subscriptionEndpointService: any SubscriptionEndpointServiceV1,
    ...
    @discardableResult
    public func restoreAccountFromPastPurchase() async -> Result<Void, AppStoreRestoreFlowErrorV1> {

...
public protocol StripePurchaseFlowV1 {
    func subscriptionOptions() async -> Result<SubscriptionOptionsV1, StripePurchaseFlowError>
...
public final class DefaultStripePurchaseFlowV1: StripePurchaseFlowV1 {
    ...
    public func subscriptionOptions() async -> Result<SubscriptionOptionsV1, StripePurchaseFlowError> {
        ...
        return .success(SubscriptionOptionsV1(platform: SubscriptionPlatformName.stripe,
                                              options: options,
                                              features: features))
    }

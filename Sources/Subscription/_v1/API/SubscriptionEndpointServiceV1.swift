//
//  SubscriptionEndpointServiceV1.swift
//
...
public struct GetSubscriptionFeaturesResponseV1: Decodable {
...
public struct ConfirmPurchaseResponseV1: Decodable {
...
public protocol SubscriptionEndpointServiceV1 {
    ...
    func getSubscriptionFeatures(for subscriptionID: String) async -> Result<GetSubscriptionFeaturesResponseV1, APIServiceError>
    ...
    ) async -> Result<ConfirmPurchaseResponseV1, APIServiceError>
}

extension SubscriptionEndpointServiceV1 {
...
public struct DefaultSubscriptionEndpointServiceV1: SubscriptionEndpointServiceV1 {
    private let currentServiceEnvironment: SubscriptionEnvironment.ServiceEnvironment
    private let apiService: APIServiceV1
    ...
    public init(currentServiceEnvironment: SubscriptionEnvironment.ServiceEnvironment, apiService: APIServiceV1) {
    ...
    public func getSubscriptionFeatures(for subscriptionID: String) async -> Result<GetSubscriptionFeaturesResponseV1, APIServiceError> {
    ...
    public func confirmPurchase(accessToken: String, signature: String, additionalParams: [String: String]?) async -> Result<ConfirmPurchaseResponseV1, APIServiceError> {

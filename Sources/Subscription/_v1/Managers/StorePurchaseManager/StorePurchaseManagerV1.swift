...
public protocol StorePurchaseManagerV1 {
    ...
    func subscriptionOptions() async -> SubscriptionOptionsV1?
    ...
    func freeTrialSubscriptionOptions() async -> SubscriptionOptionsV1?
...
public final class DefaultStorePurchaseManagerV1: ObservableObject, StorePurchaseManagerV1 {

    private let storeSubscriptionConfiguration: StoreSubscriptionConfiguration
    private let subscriptionFeatureMappingCache: SubscriptionFeatureMappingCacheV1
    ...
    public init(subscriptionFeatureMappingCache: SubscriptionFeatureMappingCacheV1,
    ...
    public func subscriptionOptions() async -> SubscriptionOptionsV1? {
    ...
    public func freeTrialSubscriptionOptions() async -> SubscriptionOptionsV1? {
    ...
    private func subscriptionOptions(for products: [any SubscriptionProduct]) async -> SubscriptionOptionsV1? {
        ...
        return SubscriptionOptionsV1(platform: platform,
                                   options: options,
                                   features: features)
    }

...
public protocol SubscriptionManagerV1 {
    // Dependencies
    var accountManager: AccountManager { get }
    var subscriptionEndpointService: SubscriptionEndpointServiceV1 { get }
    var authEndpointService: AuthEndpointService { get }
    var subscriptionFeatureMappingCache: SubscriptionFeatureMappingCacheV1 { get }
    ...
    @available(macOS 12.0, iOS 15.0, *) func storePurchaseManager() -> StorePurchaseManagerV1
...
public final class DefaultSubscriptionManagerV1: SubscriptionManagerV1 {
    private let _storePurchaseManager: StorePurchaseManagerV1?
    public let accountManager: AccountManager
    public let subscriptionEndpointService: SubscriptionEndpointServiceV1
    public let authEndpointService: AuthEndpointService
    public let subscriptionFeatureMappingCache: SubscriptionFeatureMappingCacheV1
    public let currentEnvironment: SubscriptionEnvironment

    public init(storePurchaseManager: StorePurchaseManagerV1? = nil,
                accountManager: AccountManager,
                subscriptionEndpointService: SubscriptionEndpointServiceV1,
                authEndpointService: AuthEndpointService,
                subscriptionFeatureMappingCache: SubscriptionFeatureMappingCacheV1,
    ...
    public func storePurchaseManager() -> StorePurchaseManagerV1 {

//
//  SubscriptionCookieManagerV1.swift
//
...
public protocol SubscriptionCookieManagingV1 {
    init(subscriptionManager: SubscriptionManagerV1, currentCookieStore: @MainActor @escaping () -> HTTPCookieStore?, eventMapping: EventMapping<SubscriptionCookieManagerEvent>)
...
public final class SubscriptionCookieManagerV1: SubscriptionCookieManagingV1 {
    ...
    private let subscriptionManager: SubscriptionManagerV1
    ...
    convenience nonisolated public required init(subscriptionManager: SubscriptionManagerV1,
        ...
        self.init(subscriptionManager: subscriptionManager,
                  ...
                  refreshTimeInterval: SubscriptionCookieManagerV1.defaultRefreshTimeInterval)
    }

    nonisolated public required init(subscriptionManager: SubscriptionManagerV1,
                                     currentCookieStore: @MainActor @escaping () -> HTTPCookieStore?,
                                     eventMapping: EventMapping<SubscriptionCookieManagerEvent>,

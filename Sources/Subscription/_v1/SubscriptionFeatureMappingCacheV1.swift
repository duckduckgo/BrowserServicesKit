//
//  SubscriptionFeatureMappingCacheV1.swift
//
...
public protocol SubscriptionFeatureMappingCacheV1 {
    func subscriptionFeatures(for subscriptionIdentifier: String) async -> [Entitlement.ProductName]
}

public actor DefaultSubscriptionFeatureMappingCache: SubscriptionFeatureMappingCacheV1 {

    private let subscriptionEndpointService: SubscriptionEndpointServiceV1
    private let userDefaults: UserDefaults

    public init(subscriptionEndpointService: SubscriptionEndpointServiceV1, userDefaults: UserDefaults) {

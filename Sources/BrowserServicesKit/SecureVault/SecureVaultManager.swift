...
extension SecureVaultManager: AutofillSecureVaultDelegate {
    ...
    public func autofillUserScript(_: AutofillUserScript,
        ...
        do {
            ...
            //    delegate?.secureVaultManager(self, promptUserToStoreAutofillData: dataToPrompt, hasGeneratedCredentials: false, withTrigger: data.trigger)
            //    return
            //}
            ...
            // Prompt to save on form submissions
    ...
    private func existingCredentials(with autofillData: AutofillUserScript.DetectedAutofillData,
        ...
        // Do not prompt if the account exists with the same data and was not auto-generated
        guard let existingAccountId = account.id,
              ...
              autofillData.hasAutogeneratedCredentials else {
            return nil
        }

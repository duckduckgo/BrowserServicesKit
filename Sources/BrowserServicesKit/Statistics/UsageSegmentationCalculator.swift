...
public protocol UsageSegmentationCalculatorMaking {
...
public protocol UsageSegmentationCalculating {

    func processAtb(_ atb: Atb, forActivityType activityType: UsageActivityType) -> [String: String]?

}

public final class UsageSegmentationCalculatorFactory: UsageSegmentationCalculatorMaking {
...
///
public final class UsageSegmentationCalculator: UsageSegmentationCalculating {
    ...
    public func processAtb(_ atb: Atb, forActivityType activityType: UsageActivityType) -> [String: String]? {

...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/duckduckgo/TrackerRadarKit.git", exact: "2.0.0"),
        .package(url: "https://github.com/duckduckgo/sync_crypto.git", exact: "0.2.0"),
        .package(url: "https://github.com/gumob/PunycodeSwift.git", exact: "2.1.0"),
        .package(url: "https://github.com/duckduckgo/privacy-dashboard.git", exact: "3.5.0"),
        .package(url: "https://github.com/duckduckgo/content-scope-scripts.git", exact: "5.12.0"),

...
class SecureVaultManagerTests: XCTestCase {
    ...
    // When generating a private email in an empty form, a partial login (no password) should be created
    ...
    // When generating a private email in the same form, the partial login should be updated
    ...
    // When generating a user and manually typing a password, credentials should be saved
    func testWhenGeneratingAnEmailAndEnteringAPassword_ThenDataisAutosavedOnSubmit() {
    ...
    func testWhenGeneratingAPasswordAndEnteringAnEmail_ThenDataIsAutosavedOnSubmit() {
    ...
    func testWhenGeneratedPasswordIsUpdated_ThenDataIsNotAutosavedOnSubmit() {
        ...
        // TODO: Add check for stored creds
    ...
    func testWhenGeneratedEmailIsUpdated_ThenDataIsNotAutosavedOnSubmit() {
        var incomingCredentials = AutofillUserScript.IncomingCredentials(username: "xdt7r90@duck.com", password: "", autogenerated: true)
        var incomingData = AutofillUserScript.DetectedAutofillData(identity: nil, credentials: incomingCredentials, creditCard: nil, trigger: .emailProtection)
        manager.autofillUserScript(mockAutofillUserScript, didRequestStoreDataForDomain: "fill.dev", data: incomingData)

...
class SecureVaultManagerTests: XCTestCase {
    ...
    func testWhenGeneratingUsernameFirstThenPassword_ThenDataIsAutosaved() {
        ...
        incomingCredentials = AutofillUserScript.IncomingCredentials(username: "xdt7r90@duck.com", password: "password", autogenerated: true)
        ...
        incomingCredentials = AutofillUserScript.IncomingCredentials(username: "xdas871@duck.com", password: "password", autogenerated: true)
    ...
    func testWhenGeneratingPasswordFirstThenUsername_ThenDataIsAutosaved() {
        ...
        var incomingCredentials = AutofillUserScript.IncomingCredentials(username: "", password: "password", autogenerated: true)
        ...
        incomingCredentials = AutofillUserScript.IncomingCredentials(username: "xdt7r90@duck.com", password: "", autogenerated: true)
        incomingData = AutofillUserScript.DetectedAutofillData(identity: nil, credentials: incomingCredentials, creditCard: nil, trigger: .emailProtection)
        manager.autofillUserScript(mockAutofillUserScript, didRequestStoreDataForDomain: "fill.dev", data: incomingData)
    ...
    func testWhenGeneratingUsernameWithManualPassword_ThenDataisAutosaved() {
        ...
        incomingCredentials = AutofillUserScript.IncomingCredentials(username: "xdt7r90@duck.com", password: "typedPassword", autogenerated: true)
        ...
        XCTAssertEqual(credentials?.account.username, "xdt7r90@duck.com")
        XCTAssertEqual(credentials?.password, Data("typedPassword".utf8))
    ...
    func testWhenGeneratingPasswordWithManualUsername_ThenDataIsAutosaved() {
        ...
        var incomingCredentials = AutofillUserScript.IncomingCredentials(username: "", password: "generatedPassword", autogenerated: true)
        var incomingData = AutofillUserScript.DetectedAutofillData(identity: nil, credentials: incomingCredentials, creditCard: nil, trigger: .passwordGeneration)
        manager.autofillUserScript(mockAutofillUserScript, didRequestStoreDataForDomain: "fill.dev", data: incomingData)

        incomingCredentials = AutofillUserScript.IncomingCredentials(username: "email@example.com", password: "generatedPassword", autogenerated: true)
        incomingData = AutofillUserScript.DetectedAutofillData(identity: nil, credentials: incomingCredentials, creditCard: nil, trigger: .formSubmission)
        manager.autofillUserScript(mockAutofillUserScript, didRequestStoreDataForDomain: "fill.dev", data: incomingData)

        let credentials = try? testVault?.websiteCredentialsFor(accountId: -1)
        XCTAssertEqual(credentials?.account.username, "email@example.com")
        XCTAssertEqual(credentials?.password, Data("generatedPassword".utf8))
    ...
    func testWhenGeneratingPasswordWithParsonalEmailUsername_ThenDataIsAutosaved() {
        ...
        incomingCredentials = AutofillUserScript.IncomingCredentials(username: "jane@duck.com", password: "generatedPassword", autogenerated: false)
        incomingData = AutofillUserScript.DetectedAutofillData(identity: nil, credentials: incomingCredentials, creditCard: nil, trigger: .emailProtection)
        manager.autofillUserScript(mockAutofillUserScript, didRequestStoreDataForDomain: "fill.dev", data: incomingData)
        ...
        let credentials = try? testVault?.websiteCredentialsFor(accountId: -1)
        XCTAssertEqual(credentials?.account.username, "jane@duck.com")
        XCTAssertEqual(credentials?.password, Data("generatedPassword".utf8))
    ...
    func testWhenGeneratedPasswordIsManuallyChanged_ThenDataIsNotAutosaved() {
        ...
        incomingCredentials = AutofillUserScript.IncomingCredentials(username: "", password: "manualPassword", autogenerated: false)
        incomingData = AutofillUserScript.DetectedAutofillData(identity: nil, credentials: incomingCredentials, creditCard: nil, trigger: .passwordGeneration)
        manager.autofillUserScript(mockAutofillUserScript, didRequestStoreDataForDomain: "fill.dev", data: incomingData)

        // Autofill prompted data tests
        incomingCredentials = AutofillUserScript.IncomingCredentials(username: "email@example.com", password: "manualPassword", autogenerated: true)
        incomingData = AutofillUserScript.DetectedAutofillData(identity: nil, credentials: incomingCredentials, creditCard: nil, trigger: .formSubmission)
        ...
        XCTAssertEqual(entries?.credentials?.password, Data("manualPassword".utf8))
        ...
        XCTAssertEqual(secureVaultManagerDelegate.promptedAutofillData?.credentials?.password, Data("manualPassword".utf8))
    ...
    func testWhenGeneratedUsernameIsManuallyChanged_ThenDataIsNotAutosaved() {
        ...
        // Autofill prompted data tests
        incomingCredentials = AutofillUserScript.IncomingCredentials(username: "daniel@duck.com", password: "manualPassword", autogenerated: true)
        incomingData = AutofillUserScript.DetectedAutofillData(identity: nil, credentials: incomingCredentials, creditCard: nil, trigger: .formSubmission)
        let entries = try? manager.existingEntries(for: "fill.dev", autofillData: incomingData)
        XCTAssertEqual(entries?.credentials?.account.username, "daniel@duck.com")
        XCTAssertEqual(entries?.credentials?.password, Data("manualPassword".utf8))
        ...
        XCTAssertNotNil(secureVaultManagerDelegate.promptedAutofillData)
        XCTAssertEqual(secureVaultManagerDelegate.promptedAutofillData?.credentials?.account.username, "daniel@duck.com")
        XCTAssertEqual(secureVaultManagerDelegate.promptedAutofillData?.credentials?.password, Data("manualPassword".utf8))
    ...
    func testWhenUsingGeneratedUserNameAndThenManualInputUsername_ThenDataIsNotAutoSaved() {
        ...
        incomingCredentials = AutofillUserScript.IncomingCredentials(username: "xdt7r90@duck.com", password: "manualPassword", autogenerated: true)
        incomingData = AutofillUserScript.DetectedAutofillData(identity: nil, credentials: incomingCredentials, creditCard: nil, trigger: .formSubmission)
        manager.autofillUserScript(mockAutofillUserScript, didRequestStoreDataForDomain: "fill.dev", data: incomingData)
        ...
        var credentials = try? testVault?.websiteCredentialsFor(accountId: -1)
        XCTAssertEqual(credentials?.account.username, "xdt7r90@duck.com")
        XCTAssertEqual(credentials?.password, Data("manualPassword".utf8))
    ...
    func testWhenUsingGeneratedPasswordThenManuallyChanged_ThenPromptedDataIsCorrect() {
        ...
        incomingCredentials = AutofillUserScript.IncomingCredentials(username: "a@b.com", password: "manualPassword", autogenerated: true)
        incomingData = AutofillUserScript.DetectedAutofillData(identity: nil, credentials: incomingCredentials, creditCard: nil, trigger: .formSubmission)
        let entries = try? manager.existingEntries(for: "fill.dev", autofillData: incomingData)
        XCTAssertEqual(entries?.credentials?.account.username, "a@b.com")
        XCTAssertEqual(entries?.credentials?.password, Data("manualPassword".utf8))

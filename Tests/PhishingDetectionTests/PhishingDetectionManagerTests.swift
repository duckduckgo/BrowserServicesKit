//
//  PhishingDetectionManagerTests.swift
//
...
class PhishingDetectionManagerTests: XCTestCase {
    ...
    func testIsMalicious() async {
        ...
        let shouldNotBeMalicious = await phishingDetectionManager.isMalicious(url: nonMaliciousURL)
        XCTAssertFalse(shouldNotBeMalicious)
    }
